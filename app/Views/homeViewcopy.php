                                            ...
                                            <table class="table">
                                                <tbody>
                                                    <tr>
                                                        <td>
                                                            <div class="media">
                                                                <img src="public/assets_1/assets/img/profile-2.jpg" class="rounded-circle mr-4" alt="user">
                                                                <div class="media-body">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media">
                                                                <img src="public/assets_1/assets/img/profile-3.jpg" class="rounded-circle mr-4" alt="user">
                                                                <div class="media-body">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media">
                                                                <img src="public/assets_1/assets/img/profile-4.jpg" class="rounded-circle mr-4" alt="user">
                                                                <div class="media-body">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media">
                                                                <img src="public/assets_1/assets/img/profile-6.jpg" class="rounded-circle mr-4" alt="user">
                                                                <div class="media-body">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media">
                                                                <img src="public/assets_1/assets/img/profile-8.jpg" class="rounded-circle mr-4" alt="user">
                                                                <div class="media-body">
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="media">
                                                                <img src="public/assets_1/assets/img/profile-9.jpg" class="rounded-circle mr-4" alt="user">
                                                                <div class="media-body">
                            ...
                            <div class="card-1 br-4">
                                ...
                                <ul class="list-inline badge-collapsed-img badge-tooltip mt-5 mb-0 text-right mr-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img data-original-title="Alma Clarke" alt="admin-profile" src="public/assets_1/assets/img/profile-7.jpg" class="ml-0 bs-tooltip">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img data-original-title="Alan Green" alt="admin-profile" src="public/assets_1/assets/img/profile-8.jpg" class="bs-tooltip">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img data-original-title="Daisy Anderson" alt="admin-profile" src="public/assets_1/assets/img/profile-9.jpg" class="bs-tooltip">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img data-original-title="Judy Holmes" alt="admin-profile" src="public/assets_1/assets/img/profile-5.jpg" class="bs-tooltip">
                                    </li>
                                </ul>                                
                            </div>
                        </div>
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="public/assets_1/assets/img/large-img-7.jpg" class="img-fluid" alt="img-1" style="border-color: #3862f5;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">1</td>
                                                <td>
                                                    <img src="public/assets_1/assets/img/large-img-4.jpg" class="img-fluid" alt="img-1" style="border-color: #07e0c4;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="public/assets_1/assets/img/large-img-1.png" class="img-fluid" alt="img-1" style="border-color: #00b1f4;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="public/assets_1/assets/img/large-img-3.jpg" class="img-fluid" alt="img-1" style="border-color: #f8538d;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">1</td>                                                <td>
                                                    <img src="public/assets_1/assets/img/large-img-5.jpg" class="img-fluid" alt="img-1" style="border-color: #ffbb44;">
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <img src="public/assets_1/assets/img/large-img-2.jpg" class="img-fluid" alt="img-1" style="border-color: #25d5e4;">
                                                </td>
                                ...
                                <table class="table">
                                    <tbody>
                                        <tr>
                                            <td>
                                                <div class="media">
                                                    <img src="public/assets_1/assets/img/profile-1.jpg" class="rounded-circle mr-4" alt="user">
                                                    <div class="media-body">
                                                        <h6 class="usr-name">Shaun Park</h6>
                                                        <p class="meta-info">
                                                        ...
                                                        <div class="task-item">
                                                            ...
                                                            <ul class="list-inline">
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-5.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-6.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-7.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-8.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="task-item">
                                                            ...
                                                            <ul class="list-inline">
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-9.jpg" class="rounded-circle mb-1" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="task-item">
                                                            ...
                                                            <ul class="list-inline">
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-10.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-3.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-11.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                                <li class="list-inline-item">
                                                                    <img src="public/assets_1/assets/img/profile-12.jpg" class="rounded-circle mb-2" alt="user">
                                                                </li>
                                                            </ul>
                                                        </div>
                                                    </td>
                            ...
                            <div id="user-profile-card-1" class="card br-4" style="">
                                <div class="card-body p-0">
                                    <div class="usr-img-meta mx-auto">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-card-1.jpg" class="rounded-circle">
                                    </div>
