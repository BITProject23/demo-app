            ...
            <nav id="sidebar">
                <ul class="navbar-nav theme-brand flex-row  d-none d-lg-flex">
                    ...
                    <li class="nav-item theme-text">
                        <a href="http://localhost/demo_app/" class="nav-link"> WIDEAWAKE Solutions </a>
                    </li>
                </ul>

                <ul class="list-unstyled menu-categories" id="accordionExample">
                    <li class="menu">
                        <a href="http://localhost/demo_app/" data-toggle="collapse" aria-expanded="true" class="dropdown-toggle">
                            <div class="">
