...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="<?=base_url()?>public/assets3/img/favicon.ico"/>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="<?=base_url()?>/public/assets3/css/loader.css" rel="stylesheet" type="text/css" />
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:400,600,700" rel="stylesheet">
    <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?=base_url()?>public/assets3/css/plugins.css" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM STYLES -->
    <link href="plugins/dropzone/dropzone.min.css" rel="stylesheet" type="text/css" />
    <link href="<?=base_url()?>public/assets3/css/accounting-dashboard/style.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <header class="tabMobileView header navbar fixed-top d-lg-none">
        <div class="nav-toggle">
            ...
            <a href="index-2.html" class=""> <img src="<?=base_url()?>public/assets3/img/logo-3.png" class="img-fluid" alt="logo"></a>
        </div>
        ...
        <ul class="navbar-nav flex-row">
            <li class="nav-item dropdown language-dropdown ml-1  ml-lg-0">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="flagDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="<?=base_url()?>public/assets3/img/ca.svg" alt=""> <span class="d-lg-inline-block d-none"></span>
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="flagDropdown">
                    <a class="dropdown-item" href="javascript:void(0);"><img src="<?=base_url()?>public/assets3/img/de.svg" class="flag-width" alt=""> &#xA0;German</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="<?=base_url()?>public/assets3/img/jp.svg" class="flag-width" alt=""> &#xA0;Japanese</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="<?=base_url()?>public/assets3/img/fr.svg" class="flag-width" alt=""> &#xA0;French</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="<?=base_url()?>public/assets3/img/ru.svg" class="flag-width" alt=""> &#xA0;Russian</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="<?=base_url()?>public/assets3/img/ca.svg" class="flag-width" alt=""> &#xA0;English</a>
                </div>
            </li>
        </ul>
                    ...
                    <a class="dropdown-item" href="javascript:void(0);">
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="<?=base_url()?>public/assets3/img/profile-9.jpg" alt="Generic placeholder image">
                            </div>
                        ...
                        <div class="media">
                            <div class="usr-img mr-3">
                                <img class="usr-img rounded-circle" src="<?=base_url()?>public/assets3/img/profile-24.jpg" alt="Generic placeholder image">
                            </div>
                            <div class="media-body">
                                <div class="mt-0">
                        ...
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="<?=base_url()?>public/assets3/img/profile-3.jpg" alt="Generic placeholder image">
                            </div>
                            <div class="media-body">
                                <div class="mt-0">
                    ...
                    <a class="dropdown-item text-center  p-1" href="javascript:void(0);">
                        ...
                        <div class="notification-list ">
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="<?=base_url()?>public/assets3/img/profile-2.jpg" alt="admin-profile" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="<?=base_url()?>public/assets3/img/profile-3.jpg" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="<?=base_url()?>public/assets3/img/profile-4.jpg" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="<?=base_url()?>public/assets3/img/profile-5.jpg" alt="admin-profile">
                                    </li>
                                </ul>
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-6.jpg" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-7.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-8.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-10.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-1.jpg">
                                    </li>
                                </ul>
                            ...
                            <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-11.jpg" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-16.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-14.jpg">
                                    </li>
                                </ul>
                            </div>
                        </div>
                ...
                <ul class="navbar-nav theme-brand flex-row  d-none d-lg-flex">
                    <li class="nav-item d-flex">
                        <a href="index-2.html" class="navbar-brand">
                            <img src="<?=base_url()?>public/assets3/img/logo-3.png" class="img-fluid" alt="logo">
                        </a>
                                                            ...
                                                            <td>
                                                                ...
                                                                <div class="usr-img">
                                                                    <ul class="list-inline badge-collapsed-img mb-0 mb-0">
                                                                        <li class="list-inline-item chat-online-usr">
                                                                            <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-2.jpg" class="ml-0">
                                                                        </li>
                                                                        <li class="list-inline-item chat-online-usr">
                                                                            <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-3.jpg">
                                                                        </li>
                                                                        <li class="list-inline-item chat-online-usr">
                                                                            <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-4.jpg">
                                                                        </li>
                                                                        <li class="list-inline-item chat-online-usr">
                                                                            <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-5.jpg">
                                                                        </li>
                                                                    </ul>
                                    ...
                                    <div id="social-card-1" class="card br-4">
                                        <div class="wrapper mt-4">
                                            ...
                                            <div class="usr-meta-info">
                                                <div class="media">
                                                    <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/girl-2.png" class="rounded-circle mr-2">
                                                    <div class="media-body">
                            ...
                            <div id="user-profile-card-2" class="card br-4">
                                <div class="card-top-section br-4">
                                    ...
                                    <div class="usr-profile-meta">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/drag-2.jpg" class="img-fluid usr-profile rounded-circle">
                                    </div>
                                </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="usr-info text-center mb-5">
                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-14.jpg" class="img-fluid rounded-circle mb-3">
                        <div class=" mt-2">
                ...
                <div id="feeds-tab" class="tab-pane tab-1 fade show active">
                    ...
                    <div class="tasks">
                        ...
                        <div class="recent">
                            ...
                            <div class="media">
                                <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-13.jpg" class="img-fluid mr-3">
                                <div class="media-body">
                            ...
                            <div class="media">
                                <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-15.jpg" class="img-fluid mr-3">
                                <div class="media-body">
                        ...
                        <div class="today mt-5">
                            ...
                            <div class="media">
                                <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-7.jpg" class="img-fluid mr-3">
                                <div class="media-body">
                            ...
                            <div class="media">
                                <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-5.jpg" class="img-fluid mr-3">
                                <div class="media-body">
                            ...
                            <div class="media">
                                <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-9.jpg" class="img-fluid mr-3">
                                <div class="media-body">
                    ...
                    <div class="friends">
                        ...
                        <div class="recent">
                            ...
                            <ul class="list-inline text-center mb-5">
                                ...
                                <li class="list-inline-item">
                                    <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-1.jpg">
                                    <span class="badge badge-pill badge-new">8</span>
                                </li>

                                <li class="list-inline-item">
                                    <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-2.jpg">
                                </li>

                                <li class="list-inline-item">
                                    <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-13.jpg">
                                </li>

                                <li class="list-inline-item">
                                    <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-3.jpg">
                                    <span class="badge badge-pill badge-new">5</span>
                                </li>

                                <li class="list-inline-item">
                                    <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-4.jpg">
                                </li>
                            ...
                            <div class="friend-request">
                                ...
                                <div class="media mt-2">
                                    <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/P-2.jpg" class="img-fluid mr-3">
                                    <div class="media-body">
                                        <h6>Justin Cross</h6>
                                        <p>5 mins ago</p>
                                    </div>
                                ...
                                <div class="media mt-2">
                                    <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-6.jpg" class="img-fluid mr-3">
                                    <div class="media-body">
                                        <h6>Ernest Reeves</h6>
                                        <p>10 mins ago</p>
                                    </div>
                        ...
                        <div class="online mt-5">
                            ...
                            <div class="media d-block d-sm-flex text-sm-left text-center">
                                <img alt="admin-profile" class="mr-sm-3 mb-sm-0 mb-3" src="<?=base_url()?>public/assets3/img/c-7.jpg">
                            ...
                            <div class="media d-block d-sm-flex text-sm-left text-center">
                                <img alt="admin-profile" class="mr-sm-3 mb-sm-0 mb-3 rounded" src="<?=base_url()?>public/assets3/img/c-8.jpg">
                                <div class="media-body mb-4">
                            ...
                            <div class="media d-block d-sm-flex text-sm-left text-center">
                                <img alt="admin-profile" class="mr-sm-3 mb-sm-0 mb-3 rounded-circle" src="<?=base_url()?>public/assets3/img/c-9.jpg">
                                <div class="media-body mb-4">
                            ...
                            <div class="a-s-media mb-5">
                                ...
                                <div class="media mb-3">
                                    <div class="profile-img mr-3">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/profile-16.jpg" class="img-fluid">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media mb-3">
                                    <div class="profile-img mr-3">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-11.jpg" class="img-fluid">
                                    </div>
                                    <div class="media-body">
                                ...
                                <div class="media mb-5">
                                    <div class="profile-img mr-3">
                                        <img alt="admin-profile" src="<?=base_url()?>public/assets3/img/c-12.jpg" class="img-fluid">
                                    </div>
                                    <div class="media-body">
    ...
    <script src="<?=base_url()?>public/assets3/js/libs/jquery-3.1.1.min.js"></script>
    <script src="<?=base_url()?>public/assets3/js/loader.js"></script>
    <script src="plugins/scrollbar/jquery.mCustomScrollbar.concat.min.js"></script>
    <script src="bootstrap/js/popper.min.js"></script>
    <script src="bootstrap/js/bootstrap.min.js"></script>
    <script src="<?=base_url()?>public/assets3/js/app.js"></script>
    <script>
        $(document).ready(function() {
            App.init();
        });
    </script>
    <script src="<?=base_url()?>public/assets3/js/custom.js"></script>
    ...
    <script src="<?=base_url()?>public/assets3/js/accounting-dashboard/accounting-custom.js"></script>    
