        ...
        <!-- <ul class="navbar-nav flex-row">
            <li class="nav-item dropdown language-dropdown ml-1  ml-lg-0">
                <a href="javascript:void(0);" class="nav-link dropdown-toggle" id="flagDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <img src="public/assets_1/assets/img/ca.svg" alt=""> <span class="d-lg-inline-block d-none"></span>
                </a>
                <div class="dropdown-menu position-absolute" aria-labelledby="flagDropdown">
                    <a class="dropdown-item" href="javascript:void(0);"><img src="public/assets_1/assets/img/de.svg" class="flag-width" alt=""> &#xA0;German</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="public/assets_1/assets/img/jp.svg" class="flag-width" alt=""> &#xA0;Japanese</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="public/assets_1/assets/img/fr.svg" class="flag-width" alt=""> &#xA0;French</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="public/assets_1/assets/img/ru.svg" class="flag-width" alt=""> &#xA0;Russian</a>
                    <a class="dropdown-item" href="javascript:void(0);"><img src="public/assets_1/assets/img/ca.svg" class="flag-width" alt=""> &#xA0;English</a>
                </div>
            </li>
        </ul> -->
                    ...
                    <!-- <a class="dropdown-item" href="javascript:void(0);">
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="public/assets_1/assets/img/profile-9.jpg" alt="Generic placeholder image">
                            </div>
                        ...
                        <div class="media">
                            <div class="usr-img mr-3">
                                <img class="usr-img rounded-circle" src="public/assets_1/assets/img/profile-24.jpg" alt="Generic placeholder image">
                            </div>
                            <div class="media-body">
                                <div class="mt-0">
                        ...
                        <div class="media">
                            <div class="usr-img online mr-3">
                                <img class="usr-img rounded-circle" src="public/assets_1/assets/img/profile-3.jpg" alt="Generic placeholder image">
                            </div>
                            <div class="media-body">
                                <div class="mt-0">
                    ...
                    <!-- <a class="dropdown-item text-center  p-1" href="javascript:void(0);"> -->
                        ...
                        <!-- <div class="notification-list "> -->
                            ...
                            <!-- <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="public/assets_1/assets/img/profile-2.jpg" alt="admin-profile" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="public/assets_1/assets/img/profile-3.jpg" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="public/assets_1/assets/img/profile-4.jpg" alt="admin-profile">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img src="public/assets_1/assets/img/profile-5.jpg" alt="admin-profile">
                                    </li>
                                </ul>
                            ...
                            <!-- <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-6.jpg" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-7.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-8.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-10.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-1.jpg">
                                    </li>
                                </ul>
                            ...
                            <!-- <div class="notification-item position-relative  mb-3">
                                ...
                                <ul class="list-inline badge-collapsed-img mt-3">
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-11.jpg" class="ml-0">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-16.jpg">
                                    </li>
                                    <li class="list-inline-item chat-online-usr">
                                        <img alt="admin-profile" src="public/assets_1/assets/img/profile-14.jpg">
                                    </li>
                                </ul>
                            </div> -->
                        <!-- </div> -->
            ...
            <nav id="sidebar">
                ...
                <ul class="navbar-nav theme-brand flex-row  d-none d-lg-flex">
                    ...
                    <li class="nav-item theme-text">
                        <a href="index-2.html" class="nav-link"> WideAwakeSolutions </a>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="ecommerce" data-parent="#accordionExample">
                            <li>
                                <a href="<?=base_url()?>/Lecturer"> Add Lecturer </a>
                            </li>
                            <li>
                                <a href="ecommerce_orders.html"> View Lecturer </a>
                            </li>
                            <!-- <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="ui-features"  data-parent="#accordionExample">
                            <li>
                                <a href="<?=base_url()?>/student?"> Add Student </a>
                            </li>
                            <li>
                                <a href="ui_color_library.html"> View Student </a>
                            </li>
                            <!-- <li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="components" data-parent="#accordionExample">
                            <li>
                                <a href="<?=base_url()?>/Course"> Add Course </a>
                            </li>
                            <li>
                                <a href="component_keypad.html"> View Course </a>
                            </li>
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="forms" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="<?=base_url()?>/Subject"> Add Subject </a>
                            </li>


                            <li>
                                <a href="form_bootstrap_select.html"> View Subject </a>
                            </li>
        ...
        <div class="chat-box">
            <div class="chat-box-header">
                <div class="media">
                    ...
                    <img src="public/assets_1/assets/img/profile-3.jpg" class="rounded-circle mr-2 mt-2" alt="user">
                    <div class="media-body">
