                                ...
                                <?php echo form_open('Course_update') ?>
                                    ...
                                    <!-- <form name="form1" action='< ?php echo base_url();?>/Course_update' method ="post"> -->
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <input type="text" class="form-control-rounded form-control" name="course_name" id="course_name" value="<?= $cour['course_name']?>" placeholder="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <input type="text" class="form-control-rounded form-control" name="course_code" id="course_code" value="<?= $cour['course_code']?>" placeholder="" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <input type="text" class="form-control-rounded form-control" name="course_fee" id="course_fee" value="<?= $cour['course_fee']?>" placeholder="" required>
                                            </div>
                                        </div>
