                                ...
                                <form>
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="lecturer_first_name" placeholder="">
                                        </div>
                                    </div>
                                    <div class="form-group row mb-4">
                                        <label for="lecturer_last_name" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Last Name </label>
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="lecturer_last_name" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        <label for="lecturer_subject_name" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Subject Name </label>
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="lecturer_subject_name" placeholder="">
                                        </div>
                                    </div>

                                    <div class="form-group row mb-4">
                                        <label for="lecturer_subject_id" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Subject ID</label>
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="lecturer_subject_id" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="lecturer_nic" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <input type="email" class="form-control-rounded form-control" id="lecturer_email" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <!-- <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <input type="password" class="form-control-rounded form-control" id="hPassword" placeholder="">
                                        </div>
                                    </div> -->
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="date" class="form-control-rounded form-control" id="lecturer_bod" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="tel" class="form-control-rounded form-control" id="lecturer_contact_no" placeholder="+77xxxxxxx">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control-rounded form-control" id="lecturer_address" placeholder="">
                                        </div>
                                    </div>
