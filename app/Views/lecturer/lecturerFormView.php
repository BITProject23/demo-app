                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <!-- < ?php echo form_open('LecCreate') ?> -->
                                    <form name="lectureform" action="<?=base_url()?>/Lecturer_create" onsubmit="return lecturerValidateForm()" method="post">

                                        <div class="form-group row mb-1">
                                            <label for="lecturer_no" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Lecturer EmpNo </label>
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control-rounded form-control"  name="lecturer_no" id="lecturer_no" placeholder="">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="tel" class="form-control-rounded form-control" name="lecturer_contact_no" id="lecturer_contact_no" pattern="[0-9]{10}">
