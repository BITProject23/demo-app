                            ...
                            <div class="widget-content widget-content-area">
                                <form>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="student_nic" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                            <input type="email" class="form-control-rounded form-control" id="hEmail" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-2 col-lg-4 col-sm-2">
                                                <input type="date" class="form-control-rounded form-control" id="student_bod" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="tel" class="form-control-rounded form-control" id="student_contact_no" placeholder="+77xxxxxxx">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control-rounded form-control" id="student_address" placeholder="">
                                        </div>
                                    </div>
