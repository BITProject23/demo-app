                        ...
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <!-- < ?php echo form_open('stuCreate') ?> -->
                                    <form name="studentForm" action='<?php echo base_url();?>/stuCreate' onsubmit="return validateForm()" method ="post">
                                        <div class="form-group row mb-4">
                                            ...
                                            <span id="firstNameNameError" class="error"></span>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-4">
                                        ...
                                        <div class="form-group row mb-4">
                                            ...
                                            <div class="col-xl-10 col-lg-9 col-sm-10">
                                                    <input type="tel" class="form-control-rounded form-control" name="student_contact_no" id="student_contact_no" pattern="[0-9]{10} placeholder="+77xxxxxxx">
                                            </div>
                                        </div>
