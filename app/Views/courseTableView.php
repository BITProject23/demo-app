                                        ...
                                        <tbody>
                                            <?php foreach($courses as $cour): ?>
                                                <tr>
                                                    ...
                                                    <td><?= $cour['course_fee']?></td>
                                                    <td class="text-center"><a href="<?=base_url()?>/Course_update" data-toggle="tooltip" data-placement="top"><i class="flaticon-edit  bg-success p-1 text-white br-6 mb-1"></i></a></td>
