                            ...
                            <div class="widget-content widget-content-area">
                                <form>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="student_name" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="student_id" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="paid_amount" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="remain_amount" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="text" class="form-control-rounded form-control" id="payment_remark" placeholder="">
                                        </div>
                                    </div>
