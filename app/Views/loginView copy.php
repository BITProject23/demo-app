...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="public/assets3/img/favicon.ico"/>
    <!-- BEGIN GLOBAL MANDATORY STYLES -->
    <link href="public/assets3/css/loader.css" rel="stylesheet" type="text/css" />
    <link href='https://fonts.googleapis.com/css?family=Open+Sans:400,600,700' rel='stylesheet' type='text/css'>
    <link href="bootstrap/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="public/assets3/css/plugins.css" rel="stylesheet" type="text/css" />
    <link href="public/assets3/css/users/login-2.css" rel="stylesheet" type="text/css" />
...
<body class="login">
    ...
    <form class="form-login">
        <div class="row">
            ...
            <div class="col-md-12 text-center mb-4">
                <img alt="logo" src="public/assets3/img/was_logo1.png" class="theme-logo">
            </div>
    ...
    <script src="public/assets3/js/libs/jquery-3.1.1.min.js"></script>
    <script src="public/assets3/js/loader.js"></script>
