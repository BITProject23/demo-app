                    ...
                    <div class="col-lg-12 layout-spacing">
                        <div class="statbox widget box box-shadow">
                            ...
                            <div class="widget-content widget-content-area">
                                ...
                                <form name="paymentForm" action='<?php echo base_url();?>/Payment_Search_View' id="paymentForm" method ="post">
                                    ...
                                    <div class="form-group row mb-4">
                                        <label for="payment_from_date" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Payment from Date</label>
                                        <div class="col-xl-3 col-lg-9 col-sm-10">
                                          <input type="date" class="form-control-rounded form-control" name="payment_from_date" id="payment_from_date" placeholder="">
                                        </div>
                                    </div>

                                    <div class="form-group row mb-4">
                                        <label for="payment_to_date" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">Payment To Date</label>
                                        <div class="col-xl-3 col-lg-9 col-sm-10">
                                          <input type="date" class="form-control-rounded form-control" name="payment_to_date" id="payment_to_date" placeholder="">
                                        </div>
                                    </div>
