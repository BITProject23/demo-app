                                                ...
                                                <div class="table-responsive">
                                                    <table class="table">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php $totalPayment=0.00; $totalFee=0.00; foreach($payments as $payment): ?>
                                                                <tr>
                                                                    <td><?= $payment['course_name']?></td>
                                                                    <td><?= $payment['batch_no']?></td>
                                                                    <td><?= $payment['student_no']?></td>
                                                                    <td><?= $payment['student_first_name']?> <?= $payment['student_last_name']?></td>
                                                                    <td><?= $payment['course_fee']?><?php $totalFee += $payment['course_fee']; ?></td>
                                                                    <td><?= $payment['course_payment'];?><?php $totalPayment += $payment['course_payment']; ?></td>
