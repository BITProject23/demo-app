                            ...
                            <div class="widget-content widget-content-area">
                                <form>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="text" class="form-control-rounded form-control" id="batch_no" placeholder="">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row mb-4">
                                        ...
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                          <input type="date" class="form-control-rounded form-control" id="batch_no" placeholder="">
                                        </div>
                                    </div>                                
                                    
                                    
                                    <div class="form-group row mb-4">
                                        <label for="batch_form_time" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">From Time</label>
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="time" class="form-control-rounded form-control" id="batch_form_time" placeholder="">
                                        </div>
                                    </div>


                                    <div class="form-group row mb-4">
                                        <label for="batch_to_time" class="col-xl-2 col-sm-3 col-sm-2 col-form-label">TO Time</label>
                                        <div class="col-xl-10 col-lg-9 col-sm-10">
                                                <input type="time" class="form-control-rounded form-control" id="batch_to_time" placeholder="">
                                        </div>
                                    </div>
